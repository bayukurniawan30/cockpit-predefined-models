...
if (!count($failed)) {
    ...
    // Include pre-defined models
    include __DIR__ . '/predefined/website-information.php';
    include __DIR__ . '/predefined/main-navigation.php';
    include __DIR__ . '/predefined/about-section.php';
    include __DIR__ . '/predefined/call-to-action.php';
    include __DIR__ . '/predefined/social-media.php';
    include __DIR__ . '/predefined/blog-categories.php';
    include __DIR__ . '/predefined/blogs.php';
    include __DIR__ . '/predefined/footer.php';
    include __DIR__ . '/predefined/contact-messages.php';
    include __DIR__ . '/predefined/newsletter-list.php';
    ...
    try {
        ...
        // Save pre-defined models
        $app->module('content')->saveModel($websiteInformationModel['model']['name'], $websiteInformationModel['model']);
        $app->module('content')->saveModel($mainNavigationModel['model']['name'], $mainNavigationModel['model']);
        $app->module('content')->saveModel($footerModel['model']['name'], $footerModel['model']);
        $app->module('content')->saveModel($aboutSectionModel['model']['name'], $aboutSectionModel['model']);
        $app->module('content')->saveModel($socialMediaModel['model']['name'], $socialMediaModel['model']);
        $app->module('content')->saveModel($callToActionModel['model']['name'], $callToActionModel['model']);
        $app->module('content')->saveModel($blogCategoriesModel['model']['name'], $blogCategoriesModel['model']);
        $app->module('content')->saveModel($blogsModel['model']['name'], $blogsModel['model']);
        $app->module('content')->saveModel($contactMessagesModel['model']['name'], $contactMessagesModel['model']);
        $app->module('content')->saveModel($newsletterListModel['model']['name'], $newsletterListModel['model']);
